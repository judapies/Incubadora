...
#if (CY_PSOC3)
{
    ...
    ***************************************/
    const int32 CYCODE RTD_coeffPos[] = { -50627439, 257097715, 38021537, 32651646, -19086029, 19711832 };
    const int32 CYCODE RTD_coeffNeg[] = { -12388603, 59563818, 37926757, -46772889, -68832396, 251906530 };
