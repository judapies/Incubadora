...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000974u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480009B4u)

/* IOPINS0_4 Address: CYREG_PRT4_DM0 Size (bytes): 8 */
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x480009C0u)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x480009C8u)

/* IOPINS0_6 Address: CYREG_PRT6_DR Size (bytes): 10 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x480009D0u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x480009DCu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_OPAMP3_MX, 0x10u);
...
uint8 CYXDATA * const CYCODE ADCMux_CYAMUXSIDE_B__addrTable[6] = {
	(uint8 CYXDATA *)CYREG_PRT3_AG, (uint8 CYXDATA *)CYREG_DSM0_SW4, 
	(uint8 CYXDATA *)CYREG_OPAMP3_SW, (uint8 CYXDATA *)CYREG_DSM0_SW4, 
