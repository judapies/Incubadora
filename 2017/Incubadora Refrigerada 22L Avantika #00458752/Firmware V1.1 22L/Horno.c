...
#define   Peltierp_on        output_bit(PIN_C1,1)
#define   Peltierp_off       output_bit(PIN_C1,0)
#define   Peltiern_on        output_bit(PIN_C2,1)
#define   Peltiern_off       output_bit(PIN_C2,0)
...
float X[2]={0.0,0.0};
int8 h=0,l=0,Ajuste=0,Ajusten=0,MediaMovil=10,tiemporecta=0,flag_ganancia=0,saturado=0,Sentido=0;
short Flanco=0,Flanco1=0,Flanco2=0,visual=1,Lectura=0,LecturaTemperatura=0;
...
int16 tiempos=0,tiempos3=0,tiempoctrl=0,tinicio=0,tiempocalentamiento=0,tiemposetpoint=0,Setpoint=0;
...
float V0=0.0,R1=6210.0,Pt,Tciclo=10.0,Tpulso=0.0,error=0.0,Prom=0.0,Temperature=0.0,tmp=0.0,Ganancia=25.0,Ganancia2=20.0,desvio=0.5,Coeficiente=150.0;
