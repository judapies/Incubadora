...
void LeeEEPROM(){
   ...
   Vel1=read_eeprom(28);
   delay_ms(10);
   controlT=read_eeprom(29);
   delay_ms(10);
   Programa=read_eeprom(30);
   delay_ms(10);
}
...
void LimitaValores(){
   ...
   if(controlT>1){
      controlT=0;write_eeprom(29,0);delay_ms(20);
   }
   if(Programa>3 || Programa<1){
      Programa=1;write_eeprom(30,1);delay_ms(20);
   }
