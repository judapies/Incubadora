...
void ConfiguraInterrupciones(){
   ...
   //setup_timer_2( T2_DIV_BY_4, 131, 1);//Activa Interrupcion cada 105.6uS
   setup_timer_2( T2_DIV_BY_16, 194, 16);//Activa Interrupcion cada 9.984mS e incrementa cada 3.2us x 16 postcaler=51.2us
