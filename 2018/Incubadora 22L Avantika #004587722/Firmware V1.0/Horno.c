...
#define   Peltier_on         output_bit(PIN_C2,1)
#define   Peltier_off        output_bit(PIN_C2,0)
...
float X[2]={0.0,0.0};
int8 h=0,l=0,Ajuste=0,Ajusten=0,MediaMovil=10,tiemporecta=0,flag_ganancia=0,infinito=0,Control=0;
short Flanco=0,Flanco1=0,Flanco2=0,visual=1,Lectura=0,flag_ajuste=0,flag_ajuste2=0;
short flag_clear=0,flag_clear2=0,flag_clear3=0,flag_tiempocalentamiento=0,flag_display=0,flag_setpoint=0,flag_control=0;
...
float V0=0.0,R1=6210.0,Pt,Tciclo=10.0,Tpulso=0.0,error=0.0,Prom=0.0,Temperature=0.0,tmp=0.0,Ganancia=25.0,desvio=1.0,Coeficiente=30.0;
float Aumento=0.0,Temperatura=0.0,Saturacion=10.0,TpulsoMax=0,Potenciamax=0,Tpulsomin=0;
...
float Leer_Sensor(int media)
{
   ...
   V0 = V0/41.54; // Se elimina la ganancia
...
//-------------------------------Control de Calentamiento------------------------------------------------------------//         
   ...
   error=desvio+Setpoint-Temperatura;      // Cálculo del error ******
      ...
      if(error>2.0 && error<50 && Aumento<0.3 && flag_setpoint==0)
      {
         flag_ajuste=0;
         flag_ajuste2=0;
...
{
   delay_ms(1000);   
   Resistencia_off;Peltier_off;Buzzer_off;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      {  
         if(Opcion==2)
         {
            ...
            Gananciamax=(0.35)*Setpoint;
            Tpulsomax=(0.54*Setpoint*Tciclo)/100;
            Potenciamax=(100*Tpulsomax)/Tciclo;
